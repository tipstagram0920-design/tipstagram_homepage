...
const WEEK1_Q_LABELS: Record<string, string> = {
  ...
  q7_search: "Q6. 사기 직전에 검색할 단어·질문",
  q8_solved_experiences: "Q7. 소비자들의 문제를 해결했던 나의 경험들",
  q9_customer_change: "Q8. 내 상품·서비스를 경험한 뒤 달라진 고객의 모습",
  q10_unmet_problem: "Q9. 다른 판매자들이 채워주지 못하는 소비자의 문제",
};
