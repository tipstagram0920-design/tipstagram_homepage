  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div>
        ...
        <p className="text-xs text-white/40 mt-1.5">입장 링크를 이 메일로 보내드립니다.</p>
      </div>
      ...
      <label className="flex items-start gap-3 cursor-pointer pt-1">
        ...
        <span className="text-xs text-white/65 leading-relaxed">
          무료 라이브 안내·관련 콘텐츠 발송 목적의 개인정보 수집·이용에 동의합니다.
          이름·이메일은 라이브 운영·안내 목적으로만 사용되며, 신청자가 요청 시 즉시 파기됩니다.
        </span>
      </label>
